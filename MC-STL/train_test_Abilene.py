...
parser.add_argument('--img_width', type=int, default=12, help='image width')
parser.add_argument('--img_height', type=int, default=12, help='image height')
...
parser.add_argument('--dataset', type=str, default='Abilene', help='which dataset to use: TaxiBJ, Abilene etc.')
